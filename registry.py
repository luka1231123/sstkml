...
DESCRIPTORS: tuple[ActionDescriptor, ...] = (
    ...
    _d("pay_arrears", A.PayArrears, "Pay arrears", "Pay arrears", ("roll",),
       ("pay arrears <group> <amount>",), 1,
       (Field("group", "group"), Field("amount", "quantity")),
       mnemonic="r", help_topic="pay_arrears", confirm=True),
    ...
    _d("send_to_harvest", A.SendToHarvest, "Send to fields", "Send",
       ...
       (Field("group", "group"),), mnemonic="h", help_topic="harvest_labour", confirm=True),
    _d("assign_troops", A.AssignTroops, "Assign", "Assign", ("muster",),
     ...
     _d("finance_trade", A.FinanceTrade, "Finance grain cargo", "Finance",
        ("trade",), ("finance <amount>", "finance <amount> <good>"), 1,
        (Field("amount", "quantity", argument="quantity"),
         Field("good", "good", optional=True, argument="good")),
