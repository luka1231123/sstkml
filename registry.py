...
DESCRIPTORS: tuple[ActionDescriptor, ...] = (
    ...
    _d("marry_abroad", A.MarryAbroad, "Marry abroad", "Marry",
       ...
       mnemonic="m", help_topic="house", confirm=True),
