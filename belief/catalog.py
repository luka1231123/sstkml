...
KINDS = {
    "cohort": ("id", "name", "people", "households", "origin", "ethnicity",
               ...
               "armed", "task", "path", "arrives", "until", "ration_source",
               "official", "labour_per_head", "labour", "ration_per_head",
               "ration", "allowance", "shortfall", "hunger", "grievance",
               "precedence", "corvee", "reaping", "infected", "recovered",
               "dead", "parent", "roll_id", "roll_place", "roll_function",
    ...
    "petition": ("id", "petitioner", "against", "kind", "waiting", "heard",
                 "faction", "against_faction", "unit", "claim", "counterclaim",
                 "claim_text", "counter_text", "precedent", "source",
                 "as_of_turn", "certainty"),
...
UNITS = {
    ...
    "hunger": "fortnights", "arrives": "turn", "until": "turn",
